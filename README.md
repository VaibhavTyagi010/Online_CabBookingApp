...
It is built to support all the functionality related to managing a Cab booking system. 
...
Admin will be responsible for keeping a check on the booking of cab, managing CabBooking, drivers,
payments, etc. On the other hand, Users can register themselves, log in using the login credentials,
view and book the Cab, view charges, etc.
